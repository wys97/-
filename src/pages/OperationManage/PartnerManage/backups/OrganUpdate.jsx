...
import {Button, DatePicker, Form, Grid, Input, Select} from '@alifd/next/lib/index';
              ...
              <Row>
                <Col span="12">
                  <FormItem style={styles.formItem} required label="合作机构编号:">
                    <Input style={_.compact(styles.formInputBorder, styles.formContent)} placeholder=""/>
                  </FormItem>
                </Col>
                <Col span="12">
              ...
              <Row>
                ...
                <Col span="12">
                  <FormItem labelTextAlign='right' style={styles.formItem} label="行政区划:">
                    <Input style={_.compact(styles.formInputBorder, styles.formContent)}
                           placeholder=""/>
                  </FormItem>
                </Col>
              </Row>
