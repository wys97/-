...
import LoanApplyDetail from './ApplyDetail/LoanApplyDetail'
...
export default class LoanApprovalApp extends Component {

  static displayName = 'LoanApprovalApp';
  static propTypes = {};
  static defaultProps = {};
  ...
  getApprovalDetail = () => {
    loanApprovalManageApi.approvalDetail(this.state.id)
      .then((res) => {
  ...
  approval = (v, e) => {
    ...
    loanApprovalManageApi.addApproval(v)
      .then((res) => {
        if (res.data.code === '200') {
          this.goBack();
    ...
    if (this.props.location.state === null || this.props.location.state === undefined) {
      ...
      return (
        <div>
          ...
          <LoanApplyDetail id={this.state.id}/>
        </div>
      );
    }
  }
